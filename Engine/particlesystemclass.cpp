...
ParticleSystemClass::ParticleSystemClass()
{
	...
	m_particlePositionX = 0;
	m_particlePositionY = 0;
	m_particlePositionZ = 0;
}
...
{
	m_particlePositionX = x;
	m_particlePositionY = y + 5.0f;
	m_particlePositionZ = z;
...
bool ParticleSystemClass::InitializeParticleSystem()
{
	...
	m_particleDeviationX = 4.5f;
	m_particleDeviationY = 0.1f;
	m_particleDeviationZ = 4.0f;
...
void ParticleSystemClass::EmitParticles(float frameTime)
{
	...
	if((emitParticle == true) && (m_currentParticleCount < (m_maxParticles - 1)))
	{
		...
		positionX = (((float)rand()-(float)rand())/RAND_MAX) * m_particleDeviationX + m_particlePositionX;
		positionY = (((float)rand()-(float)rand())/RAND_MAX) * m_particleDeviationY + m_particlePositionY;
		positionZ = (((float)rand()-(float)rand())/RAND_MAX) * m_particleDeviationZ + m_particlePositionZ;

		velocity = m_particleVelocity + (((float)rand()-(float)rand())/RAND_MAX) * m_particleVelocityVariation;

		//red   = (((float)rand()-(float)rand())/RAND_MAX) + 0.5f;
		red = 1.0f;
		green = 0*(((float)rand()-(float)rand())/RAND_MAX) + 0.2f;
		blue  = 0*(((float)rand()-(float)rand())/RAND_MAX) + 0.1f;
